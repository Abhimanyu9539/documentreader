...
class ConversationalRAG:
    ...
    def __init__(self, session_id: Optional[str], retriever=None):
        try:
            ...
            self.logger.info("ConversationalRAG initialized", session_id=self.session_id)
    ...
    def _build_lcel_chain(self):
        try:
            ...
            self.logger.info("LCEL graph built successfully", session_id=self.session_id)
        except Exception as e:
            self.logger.error("Failed to build LCEL chain", error=str(e), session_id=self.session_id)
