...
class ConversationalRAG:
    ...
    def invoke(self, user_input: str, chat_history: Optional[list[BaseMessage]] = None) -> str:
        try:
            ...
            self.logger.info("RAG invocation successful", session_id=self.session_id)
            if not answer:
                self.logger.info('No answer generated by RAG chain', user_input=user_input, session_id=self.session_id)
                return "No answer could be generated based on the provided documents."
            
            self.logger.info('Answer generated by RAG chain', 
